...
import { kolbQuestions, learningModes } from '../data/kolbQuestions';
import './KolbTest.css';
...
const KolbTest = () => {
    ...
    const calculateResults = () => {
        ...
        const x = newScores.B - newScores.D;
        const y = newScores.A - newScores.C;
        ...
        <div className="kolb-test fade-in">
            ...
            <div className="questions-list">
                {kolbQuestions.map((q) => {
                    ...
                    return (
                        <div key={q.id} className={`question-card card ${isValid ? 'valid' : 'invalid'}`}>
                            <h4>{q.id}. {q.prompt}</h4>
